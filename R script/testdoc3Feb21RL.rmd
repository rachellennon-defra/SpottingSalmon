...
shhh <- suppressPackageStartupMessages # Supress library messages. 
...
# Output of document at end of script
thisfilename<-"~/SpottingSalmon/R script/testdoc3Feb21.docx" 

# Handle re-ordering of electrode formation if inverted
